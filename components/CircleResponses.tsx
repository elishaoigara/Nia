...
export default function CircleResponses({ circleId, userId }: Props) {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel(`circle-responses-${circleId}`)
      .on('postgres_changes', { event: 'INSERT', schema: 'public', table: 'circle_responses', filter: `circle_id=eq.${circleId}` }, payload => {

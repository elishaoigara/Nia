...
export default function SettingsPage() {
 ...
 return <main className="settings-page space-y-6">
  ...
  <nav aria-label="Help and policies" className="flex gap-4 flex-wrap text-sm"><Link href="/help">Help</Link><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link><Link href="/community-guidelines">Community guidelines</Link></nav>
  <LogoutButton/>
 </main>
}

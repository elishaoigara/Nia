...
export default function VerifyPage() {
  ...
  async function handleMpesaVerify() {
    ...
    try {
      ...
      // Trigger M-Pesa STK push for $2 equivalent (KES ~260)
    ...
    <main className="max-w-md mx-auto px-4 py-6 space-y-6">
      ...
      {step === 'info' && (
        <>
          ...
          <div className="card p-6 text-center space-y-3">
            <div className="w-20 h-20 rounded-3xl mx-auto flex items-center justify-center text-white text-3xl font-black"
            ...
            <p className="text-sm" style={{ color: 'var(--text-tertiary)' }}>This is what your profile looks like verified</p>
          </div>
          ...
          <div className="card p-5 space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="font-extrabold text-2xl">$2 <span className="text-base font-normal" style={{ color: 'var(--text-tertiary)' }}>/ month</span></p>
                <p className="text-sm" style={{ color: 'var(--text-tertiary)' }}>≈ KES 260 · NGN 3,200 · GHS 30</p>
              </div>
      ...
      {step === 'pay' && (
        <div className="card p-6 space-y-4 text-center">
          ...
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
            An M-Pesa prompt has been sent to your phone. Enter your PIN to complete payment of <strong>KES 260</strong>.
          </p>
          <p className="text-xs px-3 py-2 rounded-xl" style={{ background: 'var(--surface-2)', color: 'var(--text-tertiary)', fontFamily: 'monospace' }}>
            Ref: {paymentRef || 'Pending…'}
          </p>
          <button
      ...
      {step === 'done' && (
        <div className="card p-8 space-y-4 text-center">
          ...
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
            Your verification payment has been recorded. Your badge will be activated within 24 hours.
          </p>

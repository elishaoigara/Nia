...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden" style={{ background: 'var(--surface-0)' }}>
      {/* Background blobs */}
      <div className="absolute top-0 left-0 w-64 h-64 rounded-full blur-[100px] opacity-20" style={{ background: 'var(--nia-violet)', transform: 'translate(-30%, -30%)' }} />
      <div className="absolute bottom-0 right-0 w-64 h-64 rounded-full blur-[100px] opacity-20" style={{ background: 'var(--nia-coral)', transform: 'translate(30%, 30%)' }} />
      ...
      <div className="w-full max-w-sm space-y-8 relative z-10">
        ...
        <div className="text-center space-y-3">
          ...
          <div>
            ...
            <p className="text-sm mt-1" style={{ color: 'var(--text-secondary)' }}>Your campus is waiting for you 🎓</p>
          </div>
        </div>
        ...
        <div className="card p-6 space-y-4">
          <div className="space-y-1.5">
            ...
            <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@university.ac.ke" className="input" />
          </div>
          <div className="space-y-1.5">
        ...
        <p className="text-center text-sm" style={{ color: 'var(--text-secondary)' }}>
          New to Nia?{' '}
          <Link href="/signup" className="font-bold" style={{ color: 'var(--nia-violet)' }}>Create account →</Link>
        </p>
      </div>
    </div>
  )

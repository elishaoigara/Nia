...
export default function DirectMessagePage() {
  ...
  async function sendMessage(
    ...
    if ((!text?.trim() && !media_url) || !currentUserId) {
      return
    }
  ...
  async function handleViewOnce(msg: Message) {
    if (msg.viewed_at || msg.sender_id === currentUserId) {
      return
    }
  ...
  function toggleAudio(msgId: string, url: string) {
    ...
    if (!audioRefs.current[msgId]) {
      ...
      audioRefs.current[msgId].onended = () => {
        setPlayingAudio(null)
      }
    }
      ...
      >
        <div className="max-w-[78%] space-y-1">
          ...
          {msg.reply_to && replyMsg && (
            <div
              className={`text-xs px-3 py-1.5 rounded-xl opacity-70 ${
                isOwn ? 'ml-auto' : ''
              }`}
              style={{
          ...
          <div className="flex items-end gap-1.5">
            ...
            >
              ...
              {msg.media_url &&
                msg.media_type ===
                  ...
                  <video
                    src={msg.media_url}
                    controls
                    className="max-w-[260px] max-h-[320px]"
                  />
                )}
              ...
              {msg.content && (
                <p className="px-4 py-2.5 text-[15px] leading-relaxed">
                  {msg.content}
                </p>
              )}
    ...
    >
      ...
      >
        ...
        {recipient && (
          ...
          >
            <div
              className="w-9 h-9 rounded-full overflow-hidden flex items-center justify-center text-white font-bold text-sm"
              style={{
                background:
                  'var(--grad-brand)'
              }}
      ...
      >
        ...
        {isRecording ? (
          ...
          <div className="flex items-end gap-2">
            ...
            <div className="flex-1 flex items-center gap-2 px-3 py-2.5 rounded-2xl bg-gray-100">
            ...
            <button
              ...
              className="w-10 h-10 flex items-center justify-center rounded-2xl text-white bg-purple-500"
            >
              {sending ||
              uploading ? (
                <Loader2 className="animate-spin" />
